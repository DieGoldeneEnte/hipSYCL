...
#error "SPIR-V built-ins are not available. Please set -fdeclare-spirv-builtins flag."
#endif
...
extern SYCL_EXTERNAL TempRetT __spirv_ImageSampleExplicitLod(SampledType, TempArgT, int,
                                                             float);
...
#define __SPIRV_ATOMIC_LOAD(AS, Type)                                                  \
  extern SYCL_EXTERNAL Type __spirv_AtomicLoad(AS const Type *P, __spv::Scope::Flag S, \
                                               __spv::MemorySemanticsMask::Flag O);
#define __SPIRV_ATOMIC_STORE(AS, Type)           \
  extern SYCL_EXTERNAL void __spirv_AtomicStore( \
      AS Type *P, __spv::Scope::Flag S, __spv::MemorySemanticsMask::Flag O, Type V);
...
#define __SPIRV_ATOMIC_MINMAX(AS, Op)                                                   \
  template<typename T>                                                                  \
  typename std::enable_if<std::is_signed<T>::value, T>::type __spirv_Atomic##Op(        \
      AS T *Ptr, __spv::Scope::Flag Memory, __spv::MemorySemanticsMask::Flag Semantics, \
      T Value) {                                                                        \
...
#define __SPIRV_ATOMICS(macro, Arg) \
  macro(__attribute__((opencl_global)), Arg) macro(__attribute__((opencl_local)), Arg)
...
extern SYCL_EXTERNAL ap_int<Wout> __spirv_ArbitraryFloatCastFromIntINTEL(
    ap_int<WA> A, int32_t Mout, int32_t EnableSubnormals = 0, int32_t RoundingMode = 0,
    int32_t RoundingAccuracy = 0) noexcept;

template<int WA, int Wout>
extern SYCL_EXTERNAL ap_int<Wout> __spirv_ArbitraryFloatCastToIntINTEL(
    ap_int<WA> A, int32_t MA, int32_t EnableSubnormals = 0, int32_t RoundingMode = 0,
    int32_t RoundingAccuracy = 0) noexcept;

template<int WA, int WB, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatAddINTEL(ap_int<WA> A, int32_t MA, ap_int<WB> B, int32_t MB,
...
template<int WA, int WB, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatSubINTEL(ap_int<WA> A, int32_t MA, ap_int<WB> B, int32_t MB,
                                   int32_t Mout, int32_t EnableSubnormals = 0,
                                   int32_t RoundingMode     = 0,
                                   int32_t RoundingAccuracy = 0) noexcept;
...
template<int WA, int WB, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatMulINTEL(ap_int<WA> A, int32_t MA, ap_int<WB> B, int32_t MB,
                                   int32_t Mout, int32_t EnableSubnormals = 0,
                                   int32_t RoundingMode     = 0,
                                   int32_t RoundingAccuracy = 0) noexcept;
...
template<int WA, int WB, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatDivINTEL(ap_int<WA> A, int32_t MA, ap_int<WB> B, int32_t MB,
                                   int32_t Mout, int32_t EnableSubnormals = 0,
                                   int32_t RoundingMode     = 0,
                                   int32_t RoundingAccuracy = 0) noexcept;
...
extern SYCL_EXTERNAL bool __spirv_ArbitraryFloatGTINTEL(ap_int<WA> A, int32_t MA,
                                                        ap_int<WB> B,
                                                        int32_t    MB) noexcept;

template<int WA, int WB>
extern SYCL_EXTERNAL bool __spirv_ArbitraryFloatGEINTEL(ap_int<WA> A, int32_t MA,
                                                        ap_int<WB> B,
                                                        int32_t    MB) noexcept;

template<int WA, int WB>
extern SYCL_EXTERNAL bool __spirv_ArbitraryFloatLTINTEL(ap_int<WA> A, int32_t MA,
                                                        ap_int<WB> B,
                                                        int32_t    MB) noexcept;

template<int WA, int WB>
extern SYCL_EXTERNAL bool __spirv_ArbitraryFloatLEINTEL(ap_int<WA> A, int32_t MA,
                                                        ap_int<WB> B,
                                                        int32_t    MB) noexcept;

template<int WA, int WB>
extern SYCL_EXTERNAL bool __spirv_ArbitraryFloatEQINTEL(ap_int<WA> A, int32_t MA,
                                                        ap_int<WB> B,
                                                        int32_t    MB) noexcept;
...
template<int WA, int WB, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatHypotINTEL(ap_int<WA> A, int32_t MA, ap_int<WB> B, int32_t MB,
                                     int32_t Mout, int32_t EnableSubnormals = 0,
                                     int32_t RoundingMode     = 0,
                                     int32_t RoundingAccuracy = 0) noexcept;
...
template<int WA, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatLogINTEL(ap_int<WA> A, int32_t MA, int32_t Mout,
...
template<int WA, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatExpINTEL(ap_int<WA> A, int32_t MA, int32_t Mout,
                                   int32_t EnableSubnormals = 0, int32_t RoundingMode = 0,
                                   int32_t RoundingAccuracy = 0) noexcept;
...
template<int WA, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatSinINTEL(ap_int<WA> A, int32_t MA, int32_t Mout,
                                   int32_t EnableSubnormals = 0, int32_t RoundingMode = 0,
                                   int32_t RoundingAccuracy = 0) noexcept;

template<int WA, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatCosINTEL(ap_int<WA> A, int32_t MA, int32_t Mout,
                                   int32_t EnableSubnormals = 0, int32_t RoundingMode = 0,
                                   int32_t RoundingAccuracy = 0) noexcept;
...
template<int WA, int WB, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatATan2INTEL(ap_int<WA> A, int32_t MA, ap_int<WB> B, int32_t MB,
                                     int32_t Mout, int32_t EnableSubnormals = 0,
                                     int32_t RoundingMode     = 0,
                                     int32_t RoundingAccuracy = 0) noexcept;
...
template<int WA, int WB, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatPowINTEL(ap_int<WA> A, int32_t MA, ap_int<WB> B, int32_t MB,
                                   int32_t Mout, int32_t EnableSubnormals = 0,
                                   int32_t RoundingMode     = 0,
                                   int32_t RoundingAccuracy = 0) noexcept;
...
template<int WA, int WB, int Wout>
extern SYCL_EXTERNAL ap_int<Wout>
    __spirv_ArbitraryFloatPowRINTEL(ap_int<WA> A, int32_t MA, ap_int<WB> B, int32_t MB,
                                    int32_t Mout, int32_t EnableSubnormals = 0,
                                    int32_t RoundingMode     = 0,
                                    int32_t RoundingAccuracy = 0) noexcept;
...
extern SYCL_EXTERNAL ap_int<Wout> __spirv_ArbitraryFloatPowNINTEL(
    ap_int<WA> A, int32_t MA, ap_int<WB> B, int32_t Mout, int32_t EnableSubnormals = 0,
    int32_t RoundingMode = 0, int32_t RoundingAccuracy = 0) noexcept;
...
template<typename dataT>
extern SYCL_EXTERNAL int32_t __spirv_WritePipe(WPipeTy<dataT> Pipe, const dataT *Data,
                                               int32_t Size, int32_t Alignment) noexcept;
template<typename dataT>
extern SYCL_EXTERNAL void __spirv_ReadPipeBlockingINTEL(RPipeTy<dataT> Pipe, dataT *Data,
                                                        int32_t Size,
                                                        int32_t Alignment) noexcept;
template<typename dataT>
extern SYCL_EXTERNAL void __spirv_WritePipeBlockingINTEL(WPipeTy<dataT> Pipe,
                                                         const dataT *Data, int32_t Size,
                                                         int32_t Alignment) noexcept;
template<typename dataT>
extern SYCL_EXTERNAL RPipeTy<dataT>
    __spirv_CreatePipeFromPipeStorage_read(const ConstantPipeStorage *Storage) noexcept;
template<typename dataT>
extern SYCL_EXTERNAL WPipeTy<dataT>
    __spirv_CreatePipeFromPipeStorage_write(const ConstantPipeStorage *Storage) noexcept;

extern SYCL_EXTERNAL void __spirv_ocl_prefetch(const
                                               __attribute__((opencl_global)) char *Ptr,
...
extern __SYCL_EXPORT void __spirv_ocl_prefetch(const char *Ptr, size_t NumBytes) noexcept;
